...
def get_page_content(url):
    """get_page_content takes an url and return the content of the page"""
    try:
...
def get_next_page(url, content):
    """Checks the content of a book list page and
    returns link of the next page"""
...
if __name__ == "__main__":
    # Compile differenct regular expression patterns
    ...
    crawl_website()
    # print a messege after the crawling done.
    print("Crawling Done!")
